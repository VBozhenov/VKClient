...
class NewsController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        tableView.rowHeight = cell.newsText.frame.size.height + cell.newsFotoCollection.frame.size.height * 1.3
...
//                newsController.foto = News.news[newsTexts[indexPath.row]]
            }
        }
